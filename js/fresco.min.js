...
!(function (i, e) {
  ...
  var Fit = {
    within: function (i, e) {
      for (
        var t = $.extend({ height: !0, width: !0 }, arguments[2] || {}),
          s = $.extend({}, e),
          n = 1,
          o = 5,
          a = t.width,
          h = t.height;
        0 < o && ((a && s.width > i.width) || (h && s.height > i.height));
        ...
        a && s.width > i.width && (r = i.width / s.width),
          ...
          (n = Math.min(r, d)),
          (s = { width: e.width * n, height: e.height * n }),
          o--;
      }
      return (
        (s.width = Math.max(s.width, 0)), (s.height = Math.max(s.height, 0)), s
      );
    },
  };
  $.extend($.easing, {
  ...
  function S(i, e) {
    ...
    return (function (i, e) {
      for (var t in i)
        if (void 0 !== O.style[i[t]]) return "prefix" !== e || i[t];
      return !1;
      ...
      getScrollDimensions: function () {
        ...
        return (
          $.each(["width", "height"], function (i, e) {
            ...
            n[e] =
              (Browser.IE
                ? Math.max(s["offset" + t], s["scroll" + t])
                : Browser.WebKit
                ? document.body["scroll" + t]
                : s["scroll" + t]) || 0;
          }),
          n
        );
      ...
      $.extend(Oc.prototype, {
        ...
        create: function () {
          if (!this._created) {
            ...
            if (
              ...
              var e =
                  (this.view.options.loop && 1 < this._total) ||
                  1 != this._position,
                t =
                  (this.view.options.loop && 1 < this._total) ||
        ...
        _getInfoHeight: function (i) {
          ...
          var s,
            n = t[0].style.width;
          return (
            ("inside" !== this._ui && "fullclick" !== this._ui) || (n = "100%"),
            t.css({ width: i + "px" }),
        ...
        updateForced: function () {
          this.create(),
            ...
            (this._noOverflow = !1),
            0 < parseInt(this.element.css("min-width")) &&
              (this._fullClick = !0),
            0 < parseInt(this.element.css("min-height")) &&
              (this._noOverflow = !0);
        },
        updateUI: function () {
          this.updateForced();
              ...
              this._whileVisible(
                $.proxy(function () {
                  this._positionOutside.is(":visible") &&
                    (n = this._positionOutside.outerWidth(!0));
                }, this)
              ),
                n > s.left && (s.left = n);
            }
            ...
            switch (this._ui) {
              ...
              case "inside":
                this.caption &&
                  ...
                  this._whileVisible(
                    $.proxy(function () {
                      (l = this._getInfoHeight(d.width)) >= 0.45 * d.height &&
                        ((m = !1), (l = 0));
                    }, this),
                    a
                  )),
                ...
                p && g.push(p),
                  this._whileVisible(
                    $.proxy(function () {
                      ...
                      (d = Fit.within(
                        { width: t.width, height: Math.max(0, t.height - l) },
                        d,
                        h
                      )),
                        (o = d);
  ...
  var Thumbnails = {
    ...
    updateVars: function () {
      ...
      var u = this._previous,
        ...
        w =
          (parseInt(this.element.css("margin-" + o)) || 0) +
      ...
      (e.ipp = Math.round(k / y)),
        (this._mode = "page"),
        e.ipp <= 1 &&
          ((I = k = b), (e.sides.enabled = !1), (this._mode = "center")),
      ...
      if ((this.updateVars(), !this.disabled())) {
        ...
        if ("page" === this._mode) {
          ...
          this._previous_button[(s < 2 ? "add" : "remove") + "Class"](h),
            this._next_button[
              (s >= this._vars.pages ? "add" : "remove") + "Class"
            ](h);
  ...
  return (
    (UI.fullclick = {
      ...
      show: function (i) {
        if (this._visible)
          return this.startTimer(), void ("function" === $.type(i) && i());
        (this._visible = !0),
          this.startTimer(),
          Window.element
