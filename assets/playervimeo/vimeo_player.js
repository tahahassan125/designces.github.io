...
$jscomp.defineProperty =
  $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties
    ...
    : function (e, h, k) {
        e != Array.prototype && e != Object.prototype && (e[h] = k.value);
      };
$jscomp.owns = function (e, h) {
  return Object.prototype.hasOwnProperty.call(e, h);
};
$jscomp.polyfill = function (e, h, k, l) {
  if (h) {
    k = $jscomp.global;
    e = e.split(".");
  ...
  function (e) {
    function h() {
      ...
      try {
        ...
        if (2 != g.get(a) || 3 != g.get(f)) return !1;
        g.delete(a);
        g.set(f, 4);
        return !g.has(a) && 4 == g.get(f);
      } catch (E) {
        return !1;
      }
    }
    ...
    function l(a) {
      var n = typeof a;
      return ("object" === n && null !== a) || "function" === n;
    }
    function g(n) {
      if (!$jscomp.owns(n, a)) {
        var f = new k();
        $jscomp.defineProperty(n, a, { value: f });
      }
    }
    function p(a) {
      var f = Object[a];
    ...
    m.prototype.set = function (f, e) {
      if (!l(f)) throw Error("Invalid WeakMap key");
      g(f);
      if (!$jscomp.owns(f, a)) throw Error("WeakMap key fail: " + f);
      f[a][this.id_] = e;
      return this;
    };
    m.prototype.get = function (f) {
      return l(f) && $jscomp.owns(f, a) ? f[a][this.id_] : void 0;
    };
    m.prototype.has = function (f) {
      return l(f) && $jscomp.owns(f, a) && $jscomp.owns(f[a], this.id_);
    };
...
$jscomp.polyfill(
  ...
  function (e) {
    ...
    g.prototype.then = function (a, f) {
      ...
      var h,
        k,
        l = new g(function (a, f) {
          h = a;
          k = f;
        });
      this.callWhenSettled_(e(a, h), e(f, k));
      return l;
    };
    ...
    g.race = function (a) {
      return new g(function (f, e) {
        for (
          var g = $jscomp.makeIterator(a), h = g.next();
          !h.done;
          h = g.next()
        )
          k(h.value).callWhenSettled_(f, e);
      });
    };
    g.all = function (a) {
      ...
      return e.done
        ...
        : new g(function (a, g) {
            ...
            do
              l.push(void 0),
                m++,
                k(e.value).callWhenSettled_(h(l.length - 1), g),
                (e = f.next());
            while (!e.done);
          });
    };
...
!(function (e, h) {
  ...
  function h(c, a) {
    return 0 === c.indexOf(a.toLowerCase())
      ...
      : ""
          ...
          .concat(c.substr(0, 1).toUpperCase())
          .concat(c.substr(1));
  }
  function k(c) {
  ...
  function l(c) {
    var a = 0 < arguments.length && void 0 !== c ? c : {},
      b = a.id;
    a = a.url;
    a = b || a;
    if (!a)
    ...
    if (k(a)) return a.replace("http:", "https:");
    if (b)
      throw new TypeError(
        "\u201c".concat(b, "\u201d is not a valid video id.")
      );
  ...
  function p(a, d) {
    if (Object(a) !== a || !J.call(a, "_id"))
      throw new TypeError(
        d + " method called on incompatible receiver " + typeof a
      );
  }
  function a(a, d, b) {
  ...
  function f(a, d) {
    return (u.get(a.element) || {})[d] || [];
  }
  function m(a, d, b) {
    var c = u.get(a.element) || {};
    if (!c[d]) return !0;
    if (!b) return (c[d] = []), u.set(a.element, c), !0;
    b = c[d].indexOf(b);
    return (
      -1 !== b && c[d].splice(b, 1),
      u.set(a.element, c),
  ...
  function n(a, d) {
    return N.reduce(
      function (b, c) {
        var d = a.getAttribute("data-vimeo-".concat(c));
        return (!d && "" !== d) || (b[c] = "" === d ? 1 : d), b;
      },
      1 < arguments.length && void 0 !== d ? d : {}
    );
  }
  function D(a, d) {
    a = a.html;
    if (!d) throw new TypeError("An element must be provided");
    if (null !== d.getAttribute("data-vimeo-initialized"))
      return d.querySelector("iframe");
    var b = document.createElement("div");
    return (
      (b.innerHTML = a),
      d.appendChild(b.firstChild),
      d.setAttribute("data-vimeo-initialized", "true"),
      d.querySelector("iframe")
    );
  }
  function I(a, d, b) {
    var c = 1 < arguments.length && void 0 !== d ? d : {},
      f = 2 < arguments.length ? b : void 0;
    return new Promise(function (b, d) {
      if (!k(a))
        throw new TypeError(
          "\u201c".concat(a, "\u201d is not a vimeo.com url.")
        );
      ...
      for (q in c)
        c.hasOwnProperty(q) &&
          (e += "&".concat(q, "=").concat(encodeURIComponent(c[q])));
      var g = new (
        ...
        if (404 !== g.status)
          if (403 !== g.status)
            try {
              ...
              if (403 === c.domain_status_code)
                return (
                  D(c, f),
                  void d(Error("\u201c".concat(a, "\u201d is not embeddable.")))
                );
              b(c);
            } catch (y) {
              d(y);
            }
          else d(Error("\u201c".concat(a, "\u201d is not embeddable.")));
        else d(Error("\u201c".concat(a, "\u201d was not found.")));
      };
      g.onerror = function () {
        var b = g.status ? " (".concat(g.status, ")") : "";
        d(
          Error(
  ...
  function A(a, d, b) {
    var c, f;
    a.element.contentWindow &&
      a.element.contentWindow.postMessage &&
      ((c = { method: d }),
      void 0 !== b && (c.value = b),
      8 <=
        (f = parseFloat(
  ...
  function M(a, d) {
    ...
    (d = E(d)).event
      ? ("error" === d.event &&
          f(a, d.data.method).forEach(function (b) {
            var c = Error(d.data.message);
            c.name = d.data.name;
            b.reject(c);
            m(a, d.data.method, b);
          }),
        (e = f(a, "event:".concat(d.event))),
        (b = d.data))
      : !d.method ||
        ((c = (function (b, a) {
          var c = f(b, a);
    ...
    e.forEach(function (c) {
      try {
        if ("function" == typeof c) return void c.call(a, b);
        c.resolve(b);
      } catch (V) {}
    });
  }
  var B =
    ...
    Q = "undefined" != typeof window && void 0 !== window.postMessage;
  if (!(B || (F && Q)))
    throw Error(
  ...
  (K =
    ...
    (K.WeakMap =
      (v(g.prototype, "delete", function (a) {
        if ((p(this, "delete"), Object(a) !== a)) return !1;
        var c = a[this._id];
        return !(!c || c[0] !== a) && (delete a[this._id], !0);
      }),
      v(g.prototype, "get", function (a) {
        if ((p(this, "get"), Object(a) === a)) {
          var c = a[this._id];
          return c && c[0] === a ? c[1] : void 0;
        }
      }),
      v(g.prototype, "has", function (a) {
        if ((p(this, "has"), Object(a) !== a)) return !1;
        var c = a[this._id];
        return !(!c || c[0] !== a);
      }),
      v(g.prototype, "set", function (a, d) {
        if ((p(this, "set"), Object(a) !== a))
          throw new TypeError("Invalid value used as weak map key");
        var b = a[this._id];
        return b && b[0] === a ? (b[1] = d) : v(a, this._id, [a, d]), this;
      }),
      v(g, "_polyfill", !0),
      g)));
  var L,
    w =
      ((function (a) {
        var c = function () {
          ...
          function f() {
            for (var a = 0; a < this.chain.length; a++) {
              ...
              try {
                !1 === f
                  ? d.reject(this.msg)
                  : (c = !0 === f ? this.msg : f.call(void 0, this.msg)) ===
                    d.promise
          ...
          function y(a) {
            ...
            this.then = function (a, d) {
              ...
              return (
                (e.promise = new this.constructor(function (a, b) {
          ...
          var x = r(
            ...
            !(n = {
              ...
              drain: function () {
                var a = t;
                for (t = p = m = void 0; a; ) a.fn.call(a.self), (a = a.next);
              },
            })
          );
          return (
            r((y.prototype = x), "__NPO__", 0, !1),
            r(y, "resolve", function (a) {
        ...
        C.Promise = C.Promise || c();
        a.exports && (a.exports = C.Promise);
      })((L = { exports: {} })),
      L.exports),
    u = new WeakMap(),
    N =
      "autopause autoplay background byline color controls dnt height id loop maxheight maxwidth muted playsinline portrait responsive speed texttrack title transparent url width".split(
        " "
      ),
    r,
    G,
  ...
  F = (function () {
    function c(b) {
      ...
      if (
        ("IFRAME" === b.nodeName ||
          ((f = b.querySelector("iframe")) && (b = f)),
        "IFRAME" === b.nodeName && !k(b.getAttribute("src") || ""))
      )
        throw Error("The player element passed isn\u2019t a Vimeo embed.");
      if (z.has(b)) return z.get(b);
      this._window = b.ownerDocument.defaultView;
      this.element = b;
      this.origin = "*";
      var h;
      d = new w(function (a, c) {
        var d;
        e._onMessage = function (b) {
          if (k(b.origin) && e.element.contentWindow === b.source) {
            "*" === e.origin && (e.origin = b.origin);
            if (
              (b = E(b.data)) &&
              "error" === b.event &&
              b.data &&
              ...
              return (d.name = b.data.name), void c(d);
            }
            d = b && "ping" === b.method;
            if ((b && "ready" === b.event) || d)
              return e.element.setAttribute("data-ready", "true"), void a();
            M(e, b);
          }
        };
      ...
      return (
        ...
        t.isEnabled &&
          ...
          t.on("fullscreenchange", function () {
            (t.isFullscreen ? a : m)(e, "event:exitFullscreen", h);
            e.ready().then(function () {
              A(e, "fullscreenchange", t.isFullscreen);
            });
          })),
        this
      );
      ...
      (d = [
        {
          ...
          value: function (b, c) {
            var d = this,
              e = 1 < arguments.length && void 0 !== c ? c : {};
            return new w(function (c, f) {
              return d
                .ready()
                .then(function () {
                  a(d, b, { resolve: c, reject: f });
                  A(d, b, e);
                })
                .catch(f);
            });
        ...
        },
        {
          ...
          value: function (b, c) {
            var d = this;
            return new w(function (e, f) {
              if (((b = h(b, "set")), null == c))
                throw new TypeError("There must be a value to set.");
              return d
                .ready()
                .then(function () {
                  a(d, b, { resolve: e, reject: f });
                  A(d, b, c);
                })
                .catch(f);
            });
        ...
        },
        {
          key: "on",
          value: function (b, c) {
            if (!b) throw new TypeError("You must pass an event name.");
            if (!c) throw new TypeError("You must pass a callback function.");
            if ("function" != typeof c)
              throw new TypeError("The callback must be a function.");
            0 === f(this, "event:".concat(b)).length &&
              this.callMethod("addEventListener", b).catch(function () {});
            a(this, "event:".concat(b), c);
          },
        },
        {
          key: "off",
          value: function (a, c) {
            ...
            if (c && "function" != typeof c)
              throw new TypeError("The callback must be a function.");
            m(this, "event:".concat(a), c) &&
              this.callMethod("removeEventListener", a).catch(function (a) {});
          },
        },
        {
          key: "loadVideo",
        ...
        },
        {
          ...
          value: function (a, c) {
            return this.callMethod("addCuePoint", {
              time: a,
              data: 1 < arguments.length && void 0 !== c ? c : {},
            });
          },
        },
        {
        ...
        },
        {
          ...
          value: function (a, c) {
            ...
            return this.callMethod("enableTextTrack", { language: a, kind: c });
          },
        },
        {
          ...
          value: function () {
            ...
            return new w(function (b) {
              ...
              a._originalElement &&
                ...
                a._originalElement.removeAttribute("data-vimeo-initialized"));
              a.element &&
                "IFRAME" === a.element.nodeName &&
                a.element.parentNode &&
                (a.element.parentNode.parentNode &&
                a._originalElement &&
                a._originalElement !== a.element.parentNode
                  ? a.element.parentNode.parentNode.removeChild(
                      a.element.parentNode
                    )
                  : a.element.parentNode.removeChild(a.element));
              a.element &&
                "DIV" === a.element.nodeName &&
                a.element.parentNode &&
                (a.element.removeAttribute("data-vimeo-initialized"),
                (c = a.element.querySelector("iframe")) &&
                  c.parentNode &&
                  (c.parentNode.parentNode &&
                  a._originalElement &&
                  a._originalElement !== c.parentNode
    ...
    B ||
      ((r = (function () {
        for (
          ...
          if ((a = d[b]) && a[1] in document) {
            for (b = 0; b < a.length; b++) f[d[0][b]] = a[b];
            return f;
          }
        return !1;
      })()),
      ...
      (x = {
        request: function (a) {
          return new Promise(function (c, b) {
            function d() {
              x.off("fullscreenchange", d);
              c();
            }
            x.on("fullscreenchange", d);
            var e = (a = a || document.documentElement)[r.requestFullscreen]();
            e instanceof Promise && e.then(d).catch(b);
          });
        },
        exit: function () {
          return new Promise(function (a, d) {
            ...
            x.isFullscreen
              ? ((b = function P() {
                  x.off("fullscreenchange", P);
                  a();
                }),
                x.on("fullscreenchange", b),
                (c = document[r.exitFullscreen]()) instanceof Promise &&
                  c.then(b).catch(d))
              : a();
          });
        },
        on: function (a, d) {
          (a = G[a]) && document.addEventListener(a, d);
        },
        off: function (a, d) {
          (a = G[a]) && document.removeEventListener(a, d);
        },
      }),
      ...
      (function (a) {
        function c(a) {
          "console" in window &&
            console.error &&
            console.error("There was an error creating an embed: ".concat(a));
        }
        [].slice
          .call(
            (0 < arguments.length && void 0 !== a
              ? a
              : document
            ).querySelectorAll("[data-vimeo-id], [data-vimeo-url]")
          )
          .forEach(function (a) {
            try {
      ...
      (function (a) {
        var c = 0 < arguments.length && void 0 !== a ? a : document;
        window.VimeoPlayerResizeEmbeds_ ||
          ((window.VimeoPlayerResizeEmbeds_ = !0),
          window.addEventListener("message", function (a) {
            if (k(a.origin) && a.data && "spacechange" === a.data.event)
              for (
                var b = c.querySelectorAll("iframe"), d = 0;
                d < b.length;
                d++
              )
                if (b[d].contentWindow === a.source) {
                  b[d].parentElement.style.paddingBottom = "".concat(
                    a.data.data[0].bottom,
                    "px"
                  );
                  break;
                }
